...
def processSample(sample, openPorts, keyWords):
  features = []
  data = sample["data"]
...
def process(openPorts, keyWords):
  ...
  for sample in samples:
    ...
    X.append(processSample(sample, openPorts, keyWords))
...
significant_keywords = ["abo","abusemail","acces","adsl","ahmed","amazon","amazonaws","amzn","ao","aq","area","arm","armateo","asn","avangard","avangarddsl","bd","beeline","bh","broad","broadban d","bsnl","bt","business","cab","cable","cantv","case","cert","changes","chu","cloud","cm","comcast","company","compute","correct","csirt","customers","depo","describes","details","dial","dialup ","dnic","dnw","dnwplg","dos","dt","dtac","dtd","dyn","dynamic","dynamicip","elt","email","esp","eur","flood","fp","fpt","fregat","fttb","gate","gener","generic","genericrev","gg","globet","glob etel","gp","gprs","gsm","gvt","hai","haitt","handle","hinet","hs","hsd","hst","identify","idnic","infium","infiumhost","infra","internet","iof","iofl","ioflood","issue","issues","italy","izh","j c","jor","jt","jtotech","kb","kht","kin","kk","knet","kornet","kp","krn","krnic","kuban","kyiv","kyivstar","kz","lake","lane","leadertelecom","level","like","lir","live","luga","mailbox","mateo" ,"matters","md","mega","mgts","mig","mk","mna","mob","mobil","mobile","modified","mts","mtu","munir","mz","nev","nodes","nodesdirect","oit","opl","oran","orange","orsk","ote","outlook","ovh","ov s","packe","people","peoplenet","pinspb","pk","point","pool","postmaster","ptc","ptcl","ptn","quan","quant","quantil","quick","quickpacket","radio","registrobr","retail","revip","rue","sal","sam ","same","servers","set","seti","sib","sibir","sid","sil","sky","sn","snet","snl","spbnit","speed","street","subpoena","subpoenas","subs","subsidiary","svyaz","svyazinform","swip","tedata","tele comitalia","telecommunication","telekom","telemar","telesp","telkomsel","that","these","tien","tiennd","tis","totisp","true","truong","truongpd","tte","twnic","uic","ukrtel","umc","unable","ural ","uu","veloxzone","vh","viettel","vip","virtua","vivo","vodafone","vp","vs","vt","was","wp","xtglobal","zone","zp"]
significant_keywords_reduced = ["abo","acces","adsl","ahmed","amazon","ao","aq","area","arm","avangard","bd","beeline","bh","broad","bt","business","cab","cantv","case","cert","changes","chu","c loud","cm","comcast","company","compute","correct","csirt","customers","depo","describes","details","dial","dnic","dnw","dos","dt","dyn","elt","email","esp","eur","flood","fp","fregat","fttb","g ate","gener","gg","globet","gp","gsm","hai","handle","hinet","hs","identify","infium","infra","internet","iof","issue","italy","izh","jc","jor","jt","kb","kht","kin","kk","knet","kornet","kp","k rn","kuban","kyiv","kz","lake","lane","leadertelecom","level","like","lir","live","luga","mailbox","mateo","md","mega","mgts","mig","mk","mna","mob","modified","mts","mtu","munir","mz","nev","no des","oit","opl","oran","orsk","ote","outlook","packe","pinspb","pk","point","pool","postmaster","ptc","ptn","quan","radio","registrobr","retail","rue","sal","sam","servers","set","sib","sid","s il","sky","sn","spbnit","speed","street","subpoena","subs","svyaz","swip","tedata","telecomitalia","telecommunication","telekom","telemar","telkomsel","that","these","tien","tis","truong","tte", "twnic","uic","ukrtel","umc","unable","ural","uu","vh","vip","virtua","vivo","vodafone","vp","vs","vt","was","wp","xtglobal","zone","zp"]


process(openPorts, significant_keywords_reduced)
